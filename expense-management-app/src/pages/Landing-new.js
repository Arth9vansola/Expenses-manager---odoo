    ...
    <div className="landing-page">
      ...
      <main className="landing-main">
        ...
        <section className="testimonials-section">
          <div className="section-header">
            <h2 className="section-title">Trusted by finance teams worldwide</h2>
            <p className="section-description">
              See what our customers are saying about ExpenseFlow
            </p>
          </div>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              <div className="testimonial-content">
                <p>"ExpenseFlow has transformed our expense management process. What used to take hours now takes minutes."</p>
              </div>
              <div className="testimonial-author">
                <div className="author-avatar">SF</div>
                <div className="author-info">
                  <div className="author-name">Sarah Johnson</div>
                  <div className="author-title">Finance Director, TechCorp</div>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              <div className="testimonial-content">
                <p>"The automated approval workflows have streamlined our entire finance operation. Highly recommended!"</p>
              </div>
              <div className="testimonial-author">
                <div className="author-avatar">MD</div>
                <div className="author-info">
                  <div className="author-name">Michael Davis</div>
                  <div className="author-title">CFO, GrowthCo</div>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              <div className="testimonial-content">
                <p>"Real-time analytics and reporting give us unprecedented visibility into company spending."</p>
              </div>
              <div className="testimonial-author">
                <div className="author-avatar">EW</div>
                <div className="author-info">
                  <div className="author-name">Emily Wong</div>
                  <div className="author-title">VP Finance, StartupX</div>
                </div>
              </div>
            </div>
          </div>
